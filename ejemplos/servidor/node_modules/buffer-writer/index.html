...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://gss-mtig.github.io/web-mgeo/ejemplos/servidor/node_modules/buffer-writer/">
      ...
      <meta name="generator" content="mkdocs-1.1.2, mkdocs-material-7.0.1">
        ...
        <title>buffer-writer - Programació web</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#buffer-writer" class="md-skip">
          Saltar a contenido
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="api">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#writeraddint32num" class="md-nav__link">
    writer.addInt32(num)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#writeraddint16num" class="md-nav__link">
    writer.addInt16(num)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#writeraddcstringstring" class="md-nav__link">
    writer.addCString(string)
          ...
          <li class="md-nav__item">
  <a href="#var-buffer-writeraddheaderchar" class="md-nav__link">
    var buffer = writer.addHeader(char)
          ...
          <li class="md-nav__item">
  <a href="#var-buffer-writerjoin" class="md-nav__link">
    var buffer = writer.join()
          ...
          <li class="md-nav__item">
  <a href="#var-buffer-writerflushchar" class="md-nav__link">
    ...
    license
          ...
          <div class="md-content" data-md-component="content">
            <article class="md-content__inner md-typeset">
                  ...
                  <a href="https://github.com/gss-mtig/web-mgeo/edit/master/docs/ejemplos/servidor/node_modules/buffer-writer/README.md" title="Editar esta página" class="md-content__button md-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
                  </a>
                
                
                <h1 id="buffer-writer">buffer-writer</h1>
<p><a href="http://travis-ci.org/brianc/node-buffer-writer"><img alt="Build Status" src="https://secure.travis-ci.org/brianc/node-buffer-writer.png?branch=master" /></a></p>
...
<h3 id="var-buffer-writerjoin">var buffer = writer.join()</h3>
<p>Collects all data in the writer and joins it into a single, new buffer.</p>
<h3 id="var-buffer-writerflushchar">var buffer = writer.flush(char)</h3>
...
<p>This is kind of node-postgres specific.  If you're interested in using this for a more general purpose thing, lemme know.
I would love to work with you on getting this more reusable for your needs.</p>
