...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>-g<span class="w"> </span>express-generator@4
</code></pre></div>
<p>Create the app:</p>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>express<span class="w"> </span>/tmp/foo<span class="w"> </span><span class="o">&amp;&amp;</span><span class="w"> </span><span class="nb">cd</span><span class="w"> </span>/tmp/foo
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>git<span class="w"> </span>clone<span class="w"> </span>git://github.com/expressjs/express.git<span class="w"> </span>--depth<span class="w"> </span><span class="m">1</span>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>node<span class="w"> </span>examples/content-negotiation
</code></pre></div>
